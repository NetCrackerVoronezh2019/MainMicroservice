            	...
            	try {	
        			while(true)
        	    	{
        	    		...
        	    		if(records.count()>0)
                		{
                			...
                			ResponseEntity<List<MicroserviceInfo>> res=template.exchange("http://192.168.99.101w:7082/getAllInfo",HttpMethod.GET,null,new ParameterizedTypeReference<List<MicroserviceInfo>>(){});
